...
{
    /// <summary>
    /// Shared corridor carving for the Aqua (Corridors) layout: <see cref="CorridorPass"/> connects a
    /// set of points into a network with L-shaped corridors over water, and <see cref="IslandPass"/>
    /// reuses the single-L carve to hook each island into the floor. Pure grid ops — no Unity dependency.
    /// </summary>
